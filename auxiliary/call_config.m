function config = call_config(str)
    ...
    base=struct('trials',10, ...
      ...
      switch str.graph
       ...
       case 'brain'
         % Get the directory of this script (call_config.m) which should be in Blind_Jan
         script_dir = fileparts(mfilename('fullpath'));
         brain_data_path = fullfile(script_dir, 'Underlying Graphs', 'brain_data_processed.mat');
   ...
   switch str.Xaxis
       ...
       case 'noise-snr'
           custom.noise_snr=[10,20,50,80]; custom.vary.name = 'noise_snr'; custom.vary.values =custom.noise_snr; %Xaxis variable
       case 'maxeigenvalue'
